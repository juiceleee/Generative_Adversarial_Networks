...
D1 = torch.load("models/05_01_23_10/D_31.pt", map_location=lambda storage, loc: storage)
G1 = torch.load("models/05_01_23_10/G_31.pt", map_location=lambda storage, loc: storage)
