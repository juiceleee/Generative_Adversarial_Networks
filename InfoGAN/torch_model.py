...
class Discriminator(nn.Module):
    ...
    def __init__(self):
        ...
        self.h1 = nn.Conv2d(in_channels=1, out_channels=64, kernel_size=(4, 4), stride=2)
        self.h2 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=(4, 4), stride=2)
        self.bn1 = nn.BatchNorm2d(128)
        self.h3 = nn.Linear(in_features=7 * 7 * 64, out_features=1024)
        self.bn2 = nn.BatchNorm1d(1024)
        self.D_out = nn.Linear(in_features=1024, out_features=1)

        q = list()
        q.append(nn.Linear(1024, 128))
        q.append(nn.BatchNorm1d(128))
        q.append(nn.LeakyReLU(0.2))
        q.append(nn.Linear(128, 12)) # 2 for continuous latent codes, 10 for category.
